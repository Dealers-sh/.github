...
**A 100% on-chain mafia strategy game on Abstract.**
 
Dynamic NFTs. Tribute to *Drug Wars*, 1984.
...
| Repo | What it is |
| --- | --- |
| [`dealers-app`](https://github.com/Dealers-sh/dealers-app) | The game client. Where dealers make deals. |
| [`dealers-contracts`](https://github.com/Dealers-sh/dealers-contracts) | The on-chain brain. Game state, NFTs, logic, all of it. |
